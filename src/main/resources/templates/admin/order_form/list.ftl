            ...
            <div class="card">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                      	<#if sn??>学生学号<#elseif name??>图书名称<#else>搜索条件</#if> <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="student.sn">学生学号</a> </li>
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="goods.name">图书名称</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${name!sn!""}" id="search-value" name="<#if sn??>student.sn<#else>goods.name</#if>" placeholder="请输入搜索值">
              ...
              <div class="card-body">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="vertical-align:middle;">
                        	<img src="/photo/view?filename=${orderForm.goods.photo}" width="30px" height="30px">
                        </td>
                        <td style="vertical-align:middle;">
                ...
                <ul class="pagination ">
                  ...
                  <li class="disabled"><span>»</span></li>
                  <#else>
                  <li><a href="list?<#if sn??>student.sn<#else>goods.name</#if>=${name!sn!""}&currentPage=${pageBean.totalPage}">»</a></li>
                  </#if>
