            ...
            <div class="card">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                      	<#if goodsCategoryName??>分类名称<#elseif name??>图书名称<#else>搜索条件</#if> <span class="caret"></span>
                      </button>
                    ...
                    <input type="text" class="form-control" value="${name!goodsCategoryName!""}" id="search-value" name="<#if goodsCategoryName??>goodsCategory.name<#else>name</#if>" placeholder="请输入搜索值">
              ...
              <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">
                        	<a href="/home/goods/show?id=${goods.id}" target="_blank">
                        	<img src="/photo/view?filename=${goods.photo}" width="30px" height="30px">
                       		</a>
                        </td>
                        <td style="vertical-align:middle;">
                        	<a href="/home/goods/show?id=${goods.id}" target="_blank">${goods.name}</a>
                        </td>
                ...
                <ul class="pagination ">
                  ...
                  <#else>
                  <li><a href="list?<#if goodsCategoryName??>goodsCategory.name<#else>name</#if>=${name!goodsCategoryName!""}&currentPage=1">«</a></li>
                  </#if>
                  <#list pageBean.currentShowPage as showPage>
                  <#if pageBean.currentPage == showPage>
                  <li class="active"><span>${showPage}</span></li>
                  <#else>
                  <li><a href="list?<#if goodsCategoryName??>goodsCategory.name<#else>name</#if>=${name!goodsCategoryName!""}&currentPage=${showPage}">${showPage}</a></li>
                  </#if>
                  </#list>
                  <#if pageBean.currentPage == pageBean.totalPage>
                  <li class="disabled"><span>»</span></li>
                  <#else>
                  <li><a href="list?<#if goodsCategoryName??>goodsCategory.name<#else>name</#if>=${name!goodsCategoryName!""}&currentPage=${pageBean.totalPage}">»</a></li>
                  </#if>
