        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-danger">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">图书发布总数</p>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-success">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">求购图书发布总数</p>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-purple">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">图书评论总数</p>
                    ...
                    <div class="card-body clearfix">
                        <div class="pull-left">
                            ...
                            <p class="h3 text-white m-b-0">${showTipsUrlText}<a href="${showTipsUtl}"
                                                                                style="color:red;margin-right:20px;">www.yuanlrc.com/?fuid=6666</a><a
