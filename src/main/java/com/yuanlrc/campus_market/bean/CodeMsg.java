...
public class CodeMsg {
	...
	public static CodeMsg ADMIN_GOODSCATEGORY_DELETE_ERROR = new CodeMsg(-9002, "该分类下存在子分类或图书信息，不允许删除，请先删除子分类或图书信息后再操作！");
	public static CodeMsg ADMIN_GOODS_NO_EXIST = new CodeMsg(-9003, "图书不存在！");
	public static CodeMsg ADMIN_GOODS_STATUS_NO_CHANGE = new CodeMsg(-9004, "图书状态没有改变！");
	public static CodeMsg ADMIN_GOODS_STATUS_NOCHANGE = new CodeMsg(-19004, "图书已推荐！");
	public static CodeMsg ADMIN_GOODS_STATUS_ERROR = new CodeMsg(-9005, "图书状态错误！");
	public static CodeMsg ADMIN_GOODS_EDIT_ERROR = new CodeMsg(-9006, "图书状态编辑失败，请联系管理员！");
	public static CodeMsg ADMIN_GOODS_STATUS_UNABLE = new CodeMsg(-9007, "图书已售出，不能再编辑！");
	public static CodeMsg ADMIN_GOODS_DELETE_ERROR = new CodeMsg(-9008, "该图书存在关联数据，不允许删除！");
	public static CodeMsg ADMIN_GOODS_CATEGORY_ERROR = new CodeMsg(-9009, "请选择图书分类！");
	public static CodeMsg ADMIN_GOODS_STATUS_ERROR_ERROR = new CodeMsg(-9010, "图书已上架或者已售出，不允许编辑！");
	public static CodeMsg ADMIN_GOODS_STATUS_UNABLE_DOWN = new CodeMsg(-9011, "图书还未上架，不能下架！");
	...
	public static CodeMsg ADMIN_STUDENT_DELETE_ERROR = new CodeMsg(-9104, "该学生下存在关联数据（图书、求购图书、评论、建议信息等），请先删除关联数据再操作！");
	...
	//前端用户发布图书错误码
	public static CodeMsg HOME_STUDENT_PUBLISH_ERROR = new CodeMsg(-30000, "图书发布失败，请联系管理员！");
	public static CodeMsg HOME_STUDENT_GOODS_EDIT_ERROR = new CodeMsg(-30001, "图书发布失败，请联系管理员！");
	public static CodeMsg HOME_STUDENT_GOODS_NO_EXIST = new CodeMsg(-30002, "图书不存在！");
	public static CodeMsg HOME_STUDENT_PUBLISH_CATEGORY_EMPTY = new CodeMsg(-30003, "请选择图书分类！");
	public static CodeMsg HOME_STUDENT_NOT_LOGIN = new CodeMsg(-30004, "请先登录！");
	public static CodeMsg HOME_STUDENT_GOODS_EDIT_NULL_ERROR = new CodeMsg(-30005, "编辑失败，请联系管理员！");
	public static CodeMsg HOME_STUDENT_GOODS_STATUS_ERROR = new CodeMsg(-30006, "图书已被收购，无法再进行编辑！");
	public static CodeMsg HOME_STUDENT_GOODS_DELETE_ERROR = new CodeMsg(-30007, "删除失败，请联系管理员！");
	public static CodeMsg HOME_STUDENT_GOODS_DELETE_STATUS_ERROR = new CodeMsg(-30008, "图书已被收购，无法再删除！");

	//前端用户建议图书
	public static CodeMsg HOME_STUDENT_REPORT_GOODS_ERROR = new CodeMsg(-40000, "建议失败，请联系管理员！");
	public static CodeMsg HOME_STUDENT_REPORTED_GOODS = new CodeMsg(-40001, "您已经建议过该图书，请勿重复建议！");
	public static CodeMsg HOME_STUDENT_REPORTED_NO_EXIST = new CodeMsg(-40002, "建议信息不存在！");
	//前端用户评论
	public static CodeMsg HOME_STUDENT_COMMENT_ADD_ERROR = new CodeMsg(-50000, "评论失败，请联系管理员！");

	//收购错误码
	public static CodeMsg ADMIN_STUDENT_GOODS_PURCHASE_ERROR = new CodeMsg(-60000,"收购失败！");
