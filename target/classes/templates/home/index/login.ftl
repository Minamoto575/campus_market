...
<div class="jianyi"><a href="javascript:void(0);">*推荐使用ie8或以上版本ie浏览器或Chrome内核浏览器访问本站</a>
    <p class="m-b-0"><a href="javascript:void(0);">Copyright © 2022 </a><a href="/system/login">前往后台</a> <a
                href="javascript:void(0);">. All right reserved</a></p></div>
<div class="jianyi"></div>

<div class="modal fade" id="selectCategory" tabindex="-1" role="dialog" aria-labelledby="selectCategory"
