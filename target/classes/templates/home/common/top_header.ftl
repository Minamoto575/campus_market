	            ...
	            <div class="search-box center" >
	               <button  class="search-submit" id="search-button" onclick="searchPro()">搜索</button> 
	                <div class="input-wr">
	                    ...
	                    <input name="keyword" id="keyword" x-webkit-speech="" placeholder="搜索你想要的图书" value="${name!""}" type="text">
	                    </div>
	                </div>
	            </div>
		        ...
		        <div id="have_login" class="clearfix">
		        	<div id="person_info" class="clearfix">
			        	...
			        	<div  style="display:inline;"  class="person_name">
			        		<a href="../student/index" id="id-btn">${ylrc_student.nickname!ylrc_student.sn}</a>
			        	</div>
						<div  style="display:inline;"  class="person_name">
							<a href="../student/money?type=consumption" id="money-btn">￥${ylrc_student.balance}</a>
						</div>
			        	<div  style="display:inline;"  class="person_name">
